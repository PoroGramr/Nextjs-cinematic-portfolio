...
export async function POST(request) {
  ...
  try {
    ...
    const { data, error } = await resend.emails.send({
      from: process.env.RESEND_FROM_EMAIL || 'Junseo Park <onboarding@resend.dev>',
      to: to,
      subject: subject,
      html: `
        <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #080808; color: #ffffff; padding: 40px; border-radius: 16px; border: 1px solid #222;">
          <div style="text-align: center; margin-bottom: 30px;">
            <h2 style="margin: 0; color: #fff; font-size: 24px; letter-spacing: -0.5px;">Junseo Park</h2>
            <p style="margin: 4px 0 0; color: #ff6b1a; font-size: 12px; text-transform: uppercase; letter-spacing: 2px;">Full Stack AI Developer</p>
          </div>
          ...
          <div style="text-align: center; color: #666; font-size: 12px;">
            ...
            <p style="margin: 4px 0 0;"><a href="mailto:pjs9177@naver.com" style="color: #ff6b1a; text-decoration: none; font-weight: bold;">pjs9177@naver.com</a></p>
          </div>
        </div>
      `,
